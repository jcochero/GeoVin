...
__c.LogImpl("514024708","AutoFocus error.",0);
 };
...
__c.LogImpl("511796488","success = false, "+BA.ObjectToString(__c.LastException(ba)),0);
 };
...
__c.LogImpl("514680069",BA.ObjectToString(_facerect),0);
 }
};
...
__c.LogImpl("511665412","findCamera",0);
...
__c.LogImpl("511665416",BA.ObjectToString(_r.Target),0);
 //BA.debugLineNum = 47;BA.debugLine="Log(numberOfCameras)";
__c.LogImpl("511665417",BA.NumberToString(_numberofcameras),0);
...
__c.LogImpl("511665422","facing: "+BA.ObjectToString(_r.GetField("facing"))+", "+BA.NumberToString(_cameravalue),0);
...
_list1 = new anywheresoftware.b4a.objects.collections.List();
_list1.setObject((java.util.List)(_r.RunMethod("getSupportedPreviewSizes")));
...
__c.LogImpl("513631495","Continuous focus mode is not available",0);
 };
...
__c.LogImpl("511730960",BA.NumberToString(_previewresult),0);
 };
...
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_nativecam));
