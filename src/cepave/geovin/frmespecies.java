...
public class frmespecies extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "cepave.geovin", "cepave.geovin.frmespecies");
...
RDebugUtils.currentModule="frmespecies";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create"))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
String _html = "";
anywheresoftware.b4a.objects.WebViewWrapper _webcuerpos = null;
anywheresoftware.b4a.objects.PanelWrapper _pnlcuerpos = null;
RDebugUtils.currentLine=21823488;
 //BA.debugLineNum = 21823488;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=21823490;
 //BA.debugLineNum = 21823490;BA.debugLine="Activity.LoadLayout(\"frmaprendermas\")";
mostCurrent._activity.LoadLayout("frmaprendermas",mostCurrent.activityBA);
RDebugUtils.currentLine=21823492;
 //BA.debugLineNum = 21823492;BA.debugLine="Dim HTML As String";
_html = "";
RDebugUtils.currentLine=21823495;
 //BA.debugLineNum = 21823495;BA.debugLine="Dim webCuerpos As WebView";
_webcuerpos = new anywheresoftware.b4a.objects.WebViewWrapper();
RDebugUtils.currentLine=21823496;
 //BA.debugLineNum = 21823496;BA.debugLine="webCuerpos.Initialize(\"\")";
_webcuerpos.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=21823497;
 //BA.debugLineNum = 21823497;BA.debugLine="Dim pnlCuerpos As Panel";
_pnlcuerpos = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=21823498;
 //BA.debugLineNum = 21823498;BA.debugLine="pnlCuerpos.Initialize(\"\")";
_pnlcuerpos.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=21823500;
 //BA.debugLineNum = 21823500;BA.debugLine="pnlCuerpos.AddView(webCuerpos,0,0,90%x,100%y)";
_pnlcuerpos.AddView((android.view.View)(_webcuerpos.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
RDebugUtils.currentLine=21823501;
 //BA.debugLineNum = 21823501;BA.debugLine="HTML = File.GetText(File.DirAssets, \"ciclodevida.";
_html = anywheresoftware.b4a.keywords.Common.File.GetText(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ciclodevida.html");
RDebugUtils.currentLine=21823502;
 //BA.debugLineNum = 21823502;BA.debugLine="webCuerpos.LoadHtml(HTML)";
_webcuerpos.LoadHtml(_html);
