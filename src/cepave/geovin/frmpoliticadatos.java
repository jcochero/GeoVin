...
public class frmpoliticadatos extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "cepave.geovin", "cepave.geovin.frmpoliticadatos");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "cepave.geovin", "cepave.geovin.frmpoliticadatos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "cepave.geovin.frmpoliticadatos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="TranslateGUI";
_translategui();
 //BA.debugLineNum = 36;BA.debugLine="End Sub";
return "";
}
public static String  _btncerrarpoliticadatos_click() throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Sub btnCerrarPoliticaDatos_Click";
 //BA.debugLineNum = 108;BA.debugLine="Activity.RemoveAllViews";
...
public static String  _translategui() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub TranslateGUI";
 //BA.debugLineNum = 49;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 50;BA.debugLine="lblTitulo.Text = \"   Política de datos\"";
mostCurrent._lbltitulo.setText(BA.ObjectToCharSequence("   Política de datos"));
 //BA.debugLineNum = 51;BA.debugLine="lblTituloTipos.Text = \"   Tipos de datos que re";
mostCurrent._lbltitulotipos.setText(BA.ObjectToCharSequence("   Tipos de datos que recolectamos"));
 //BA.debugLineNum = 52;BA.debugLine="lblTipos.Text = \"- Datos de contacto \" & CRLF &";
mostCurrent._lbltipos.setText(BA.ObjectToCharSequence("- Datos de contacto "+anywheresoftware.b4a.keywords.Common.CRLF+"- Datos de tu localización"+anywheresoftware.b4a.keywords.Common.CRLF+"- Datos que identifican tu dispositivo"+anywheresoftware.b4a.keywords.Common.CRLF+"- Fotografías que asocies a cada envío"+anywheresoftware.b4a.keywords.Common.CRLF+"- Tus respuestas a las encuestas"));
 //BA.debugLineNum = 57;BA.debugLine="lblTituloComo.Text = \"   ¿Para que usamos tus d";
mostCurrent._lbltitulocomo.setText(BA.ObjectToCharSequence("   ¿Para que usamos tus datos? Para..."));
 //BA.debugLineNum = 58;BA.debugLine="lblComo.Text = 	\"... la base de datos ambientale";
mostCurrent._lblcomo.setText(BA.ObjectToCharSequence("... la base de datos ambientales de GeoVin"+anywheresoftware.b4a.keywords.Common.CRLF+"... el catálogo de imágenes de GeoVin"+anywheresoftware.b4a.keywords.Common.CRLF+"... poder poner cada reporte en un mapa"+anywheresoftware.b4a.keywords.Common.CRLF+"... contactarte por temas relacionados a tu envío"+anywheresoftware.b4a.keywords.Common.CRLF+"... enviarte información sobre GeoVin (si lo deseas solamente)"));
 //BA.debugLineNum = 63;BA.debugLine="lblTituloTerceras.Text = \"   Terceras partes qu";
mostCurrent._lbltituloterceras.setText(BA.ObjectToCharSequence("   Terceras partes que tendrán acceso a tus datos"));
 //BA.debugLineNum = 64;BA.debugLine="lblTerceras.Text = \"- Infraestructura: iPage, My";
...
mostCurrent._lbltipos.setText(BA.ObjectToCharSequence("- Contact information "+anywheresoftware.b4a.keywords.Common.CRLF+"- Localization data"+anywheresoftware.b4a.keywords.Common.CRLF+"- Information about your device"+anywheresoftware.b4a.keywords.Common.CRLF+"- Photos you take for each report"+anywheresoftware.b4a.keywords.Common.CRLF+"- Your responses to your reports"));
 //BA.debugLineNum = 84;BA.debugLine="lblTituloComo.Text = \"   What do we use the dat";
mostCurrent._lbltitulocomo.setText(BA.ObjectToCharSequence("   What do we use the data for? To..."));
 //BA.debugLineNum = 85;BA.debugLine="lblComo.Text = 	\"... feed the GeoVin database\"";
mostCurrent._lblcomo.setText(BA.ObjectToCharSequence("... feed the GeoVin database"+anywheresoftware.b4a.keywords.Common.CRLF+"... feed the GeoVin image catalog"+anywheresoftware.b4a.keywords.Common.CRLF+"... place each report in the map"+anywheresoftware.b4a.keywords.Common.CRLF+"... contact you regarding your report"+anywheresoftware.b4a.keywords.Common.CRLF+"... send you info about GeoVin (only if you want)"));
 //BA.debugLineNum = 90;BA.debugLine="lblTituloTerceras.Text = \"   Third parties that";
mostCurrent._lbltituloterceras.setText(BA.ObjectToCharSequence("   Third parties that will have access to some of your data"));
 //BA.debugLineNum = 91;BA.debugLine="lblTerceras.Text = \"- Infrastructure: iPage, MyS";
