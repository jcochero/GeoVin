...
public class b4xdrawer extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cepave.geovin.b4xdrawer");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cepave.geovin.b4xdrawer.class).invoke(this, new Object[] {null});
        else
...
_mbasepanel.setObject((java.lang.Object)(_creator.CreateTouchPanel(ba,"base").getObject()));
...
_p.setObject((android.view.ViewGroup)(_mleftpanel.getObject()));
