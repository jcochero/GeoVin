...
public class register extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "cepave.geovin", "cepave.geovin.register");
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 23;BA.debugLine="Activity.finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 24;BA.debugLine="Activity.RemoveAllViews";
...
public static String  _btncancelarregistro_click() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub btnCancelarRegistro_Click";
...
String _stremail = "";
 //BA.debugLineNum = 53;BA.debugLine="Sub btnRegister_Click";
 //BA.debugLineNum = 54;BA.debugLine="Dim strUserID As String = txtUserID.Text.Trim";
_struserid = mostCurrent._txtuserid.getText().trim();
 //BA.debugLineNum = 55;BA.debugLine="If strUserID = \"\" Then";
if ((_struserid).equals("")) { 
 //BA.debugLineNum = 56;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 57;BA.debugLine="Msgbox(\"Ingrese nombre de usuario\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Ingrese nombre de usuario"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 59;BA.debugLine="Msgbox(\"Enter a username\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 63;BA.debugLine="Dim strPassword As String = txtPassword.Text.Trim";
_strpassword = mostCurrent._txtpassword.getText().trim();
 //BA.debugLineNum = 64;BA.debugLine="If strPassword = \"\" Then";
if ((_strpassword).equals("")) { 
 //BA.debugLineNum = 65;BA.debugLine="If Main.lang = \"en\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("en")) { 
 //BA.debugLineNum = 66;BA.debugLine="Msgbox(\"Enter a password\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Enter a password"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 68;BA.debugLine="Msgbox(\"Ingrese contraseña\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 72;BA.debugLine="Dim strPassword2 As String = txtPassword2.Text.Tr";
_strpassword2 = mostCurrent._txtpassword2.getText().trim();
 //BA.debugLineNum = 73;BA.debugLine="If strPassword2 = \"\" Then";
if ((_strpassword2).equals("")) { 
 //BA.debugLineNum = 74;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 75;BA.debugLine="Msgbox(\"Confirme su contraseña\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Confirme su contraseña"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 77;BA.debugLine="Msgbox(\"Confirm your password\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 81;BA.debugLine="If strPassword <> strPassword2 Then";
if ((_strpassword).equals(_strpassword2) == false) { 
 //BA.debugLineNum = 82;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 83;BA.debugLine="Msgbox(\"Las contraseñas no coinciden\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Las contraseñas no coinciden"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 85;BA.debugLine="Msgbox(\"Passwords don't match\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 90;BA.debugLine="Dim strEmail As String = txtEmail.Text.Trim";
_stremail = mostCurrent._txtemail.getText().trim();
 //BA.debugLineNum = 91;BA.debugLine="If strEmail = \"\" Then";
if ((_stremail).equals("")) { 
 //BA.debugLineNum = 92;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 93;BA.debugLine="Msgbox(\"Ingrese email\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Ingrese email"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 95;BA.debugLine="Msgbox(\"Enter your email\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 99;BA.debugLine="If Validate_Email(strEmail) = False Then";
if (_validate_email(_stremail)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 100;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 101;BA.debugLine="Msgbox(\"Formato de email incorrecto\", \"Error\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Formato de email incorrecto"),BA.ObjectToCharSequence("Error"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 103;BA.debugLine="Msgbox(\"Incorrect format for the email address\"";
...
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 109;BA.debugLine="ProgressDialogShow(\"Registrando el usuario...\")";
...
public static String  _lblleerlegales_click() throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub lblLeerLegales_Click";
 //BA.debugLineNum = 193;BA.debugLine="StartActivity(frmPoliticaDatos)";
...
cepave.geovin.downloadservice._downloaddata _dd = null;
 //BA.debugLineNum = 117;BA.debugLine="Sub RegisterUser";
 //BA.debugLineNum = 120;BA.debugLine="Dim dd As DownloadData";
_dd = new cepave.geovin.downloadservice._downloaddata();
 //BA.debugLineNum = 121;BA.debugLine="dd.url = Main.serverPath & \"/connect2/signupUser.";
_dd.url /*String*/  = mostCurrent._main._serverpath /*String*/ +"/connect2/signupUser.php?Action=RegisterNew&"+"UserID="+mostCurrent._txtuserid.getText()+"&"+"Password="+mostCurrent._txtpassword.getText()+"&"+"Email="+mostCurrent._txtemail.getText()+"&"+"deviceID="+mostCurrent._main._deviceid /*String*/ ;
 //BA.debugLineNum = 127;BA.debugLine="dd.EventName = \"RegisterUser\"";
_dd.EventName /*String*/  = "RegisterUser";
 //BA.debugLineNum = 128;BA.debugLine="dd.Target = Me";
_dd.Target /*Object*/  = register.getObject();
 //BA.debugLineNum = 129;BA.debugLine="CallSubDelayed2(DownloadService, \"StartDownload\",";
...
public static String  _registeruser_complete(cepave.geovin.httpjob _job) throws Exception{
String _res = "";
String _action = "";
anywheresoftware.b4a.objects.collections.JSONParser _parser = null;
 //BA.debugLineNum = 132;BA.debugLine="Sub RegisterUser_Complete(Job As HttpJob)";
 //BA.debugLineNum = 133;BA.debugLine="Log(\"Register user: \" & Job.Success)";
anywheresoftware.b4a.keywords.Common.LogImpl("228049409","Register user: "+BA.ObjectToString(_job._success /*boolean*/ ),0);
 //BA.debugLineNum = 134;BA.debugLine="If Job.Success = True Then";
if (_job._success /*boolean*/ ==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 135;BA.debugLine="Dim res As String, action As String";
_res = "";
_action = "";
 //BA.debugLineNum = 136;BA.debugLine="res = Job.GetString";
_res = _job._getstring /*String*/ ();
 //BA.debugLineNum = 137;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 138;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
 //BA.debugLineNum = 139;BA.debugLine="action = parser.NextValue";
_action = BA.ObjectToString(_parser.NextValue());
 //BA.debugLineNum = 140;BA.debugLine="If action = \"Mail\" Then";
if ((_action).equals("Mail")) { 
 //BA.debugLineNum = 141;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 142;BA.debugLine="Msgbox(\"Usuario registrado!\", \"Felicitaciones\"";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Usuario registrado!"),BA.ObjectToCharSequence("Felicitaciones"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 144;BA.debugLine="Msgbox(\"User correctly registered!\", \"Congrats";
...
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 153;BA.debugLine="Msgbox(\"El usuario '\" & txtUserID.Text & \"' o";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("El usuario '"+mostCurrent._txtuserid.getText()+"' o el email ("+mostCurrent._txtemail.getText()+") ya están en uso"),BA.ObjectToCharSequence("Registro"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 155;BA.debugLine="Msgbox(\"The username '\" & txtUserID.Text & \"'";
...
if ((mostCurrent._main._lang /*String*/ ).equals("es")) { 
 //BA.debugLineNum = 159;BA.debugLine="Msgbox(\"El servidor no devolvió los valores es";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("El servidor no devolvió los valores esperados."+_job._errormessage /*String*/ ),BA.ObjectToCharSequence("Registro"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 161;BA.debugLine="Msgbox(\"The server did not return the expected";
...
anywheresoftware.b4a.keywords.Regex.MatcherWrapper _matchemail = null;
 //BA.debugLineNum = 168;BA.debugLine="Sub Validate_Email(EmailAddress As String) As Bool";
 //BA.debugLineNum = 169;BA.debugLine="Dim MatchEmail As Matcher = Regex.Matcher(\"^(?";
...
_matchemail = anywheresoftware.b4a.keywords.Common.Regex.Matcher("^(?i)[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])$",_emailaddress);
 //BA.debugLineNum = 171;BA.debugLine="If MatchEmail.Find = True Then";
