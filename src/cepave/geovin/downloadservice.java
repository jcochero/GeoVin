...
anywheresoftware.b4a.keywords.Common.LogImpl("56553602","Ignoring cancel request.",0);
 //BA.debugLineNum = 64;BA.debugLine="Log(\"url: \" & url)";
anywheresoftware.b4a.keywords.Common.LogImpl("56553603","url: "+_url,0);
 //BA.debugLineNum = 65;BA.debugLine="Log(jobs.Get(\"jobname\"))";
anywheresoftware.b4a.keywords.Common.LogImpl("56553604",BA.ObjectToString(_jobs.Get((Object)("jobname"))),0);
 //BA.debugLineNum = 66;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 68;BA.debugLine="Log(\"Cancelando: \" & url)";
anywheresoftware.b4a.keywords.Common.LogImpl("56553607","Cancelando: "+_url,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56684682",_job._errormessage /*String*/ ,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("56488066","Ignoring duplicate request.",0);
